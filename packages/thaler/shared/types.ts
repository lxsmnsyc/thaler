...
export interface ThalerPostFunction<P extends ThalerPostParam>
...
export interface ThalerGetFunction<P extends ThalerGetParam>
  extends ThalerBaseFunction {
  type: 'get';
